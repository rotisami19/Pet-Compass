...
public class PetCompassHUD implements IGuiOverlay {
    ...
    public void render(ForgeGui gui, GuiGraphics guiGraphics, float partialTick, int screenWidth, int screenHeight) {
        ...
        if (isVeryClose) {
            ...
            if (blinkState) {
                guiGraphics.drawString(mc.font, "§b§l✦ PET FOUND! ✦", x + PetCompassConstants.HUD_PADDING,
                    y + PetCompassConstants.HUD_PADDING, veryCloseColor);
            } else {
                guiGraphics.drawString(mc.font, Component.translatable("hud.petcompass.tracking"),
                    x + PetCompassConstants.HUD_PADDING, y + PetCompassConstants.HUD_PADDING, accentColor);
            }
        } else if (isNearby) {
            guiGraphics.drawString(mc.font, "§e§l◆ NEARBY!", x + PetCompassConstants.HUD_PADDING,
                y + PetCompassConstants.HUD_PADDING, nearbyColor);
        } else {
            guiGraphics.drawString(mc.font, Component.translatable("hud.petcompass.tracking"),
                x + PetCompassConstants.HUD_PADDING, y + PetCompassConstants.HUD_PADDING, accentColor);
        }
        ...
        // Pet name
        guiGraphics.drawString(mc.font, PetCompassClientData.petName, x + PetCompassConstants.HUD_PADDING,
            y + PetCompassConstants.HUD_PADDING + PetCompassConstants.HUD_LINE_HEIGHT, textColor);
        ...
        guiGraphics.drawString(mc.font, Component.translatable("hud.petcompass.distance", distanceText),
            x + PetCompassConstants.HUD_PADDING,
            y + PetCompassConstants.HUD_PADDING + PetCompassConstants.HUD_LINE_HEIGHT * 2, distanceColor);
        ...
        guiGraphics.drawString(mc.font, Component.translatable("hud.petcompass.dimension", dimensionName),
            x + PetCompassConstants.HUD_PADDING,
            y + PetCompassConstants.HUD_PADDING + PetCompassConstants.HUD_LINE_HEIGHT * 3,
            PetCompassConstants.COLOR_LIGHT_PURPLE);
        ...
        guiGraphics.drawString(mc.font, coords, x + PetCompassConstants.HUD_PADDING,
            y + PetCompassConstants.HUD_PADDING + PetCompassConstants.HUD_LINE_HEIGHT * 4,
            PetCompassConstants.COLOR_GRAY);

        // Draw paw icon when nearby
        if (isNearby) {
            drawPawIcon(guiGraphics, mc, x + panelWidth - PetCompassConstants.HUD_PAW_OFFSET,
